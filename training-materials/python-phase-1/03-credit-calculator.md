...
payload = {
    ...
    "locations": [{"state": "VIC", "suburb": "Carlton", "postCode": "3053",
                   "includeSurroundingSuburbs": False}],
    "pageSize": 1,
    "pageNumber": 1,
}
r = requests.post(url, json=payload, auth=PROXY_AUTH, headers=headers)
...
This is one of the most commonly misunderstood aspects of individual listings queries. [Notebook 1: Listings Search](../phase-2/notebook-1-listings-search.ipynb) and [Notebook 3: Pagination Tricks](../phase-2/notebook-3-pagination-tricks.ipynb) both include worked examples showing how to handle this correctly in practice.
